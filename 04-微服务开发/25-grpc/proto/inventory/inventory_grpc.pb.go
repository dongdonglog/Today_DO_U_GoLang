...
//
// Inventory 服务：演示超时/取消传播
type InventoryServiceClient interface {
	// GetStock 查询库存；slow=true 时服务端故意慢处理，用来触发客户端 deadline
	GetStock(ctx context.Context, in *GetStockReq, opts ...grpc.CallOption) (*Stock, error)
}
...
func (c *inventoryServiceClient) GetStock(ctx context.Context, in *GetStockReq, opts ...grpc.CallOption) (*Stock, error) {
...
type InventoryServiceServer interface {
	// GetStock 查询库存；slow=true 时服务端故意慢处理，用来触发客户端 deadline
	GetStock(context.Context, *GetStockReq) (*Stock, error)
...
func (UnimplementedInventoryServiceServer) GetStock(context.Context, *GetStockReq) (*Stock, error) {

...
type GetStockReq struct {
	...
	Slow          bool                   `protobuf:"varint,2,opt,name=slow,proto3" json:"slow,omitempty"`
...
func (x *GetStockReq) GetSlow() bool {
	if x != nil {
		return x.Slow
	}
	return false
...
const file_proto_inventory_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1fproto/inventory/inventory.proto\x12\tinventory\"8\n" +
	"\vGetStockReq\x12\x15\n" +
	"\x06sku_id\x18\x01 \x01(\x03R\x05skuId\x12\x12\n" +
	"\x04slow\x18\x02 \x01(\bR\x04slow\"<\n" +
	"\x05Stock\x12\x15\n" +
	"\x06sku_id\x18\x01 \x01(\x03R\x05skuId\x12\x1c\n" +
	"\tavailable\x18\x02 \x01(\x05R\tavailable2H\n" +
	"\x10InventoryService\x124\n" +
	"\bGetStock\x12\x16.inventory.GetStockReq\x1a\x10.inventory.StockB/Z-github.com/go-book/grpc/proto/inventory;invpbb\x06proto3"
...
var file_proto_inventory_inventory_proto_goTypes = []any{
	...
	(*Stock)(nil),       // 1: inventory.Stock
}
var file_proto_inventory_inventory_proto_depIdxs = []int32{
	0, // 0: inventory.InventoryService.GetStock:input_type -> inventory.GetStockReq
	1, // 1: inventory.InventoryService.GetStock:output_type -> inventory.Stock
